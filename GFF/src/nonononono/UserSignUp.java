   ...
   private void DoubleCheckIdList() {
         ...
         try {   
           conn = DBUtil.getConnection();
            ...
            while(rs.next()) {
//              memberList.add(rs.getString("login_id"));
   ...
   private void addListener() {
      ...
      OverlapBtn.addActionListener(new ActionListener() {
         ...
         public void actionPerformed(ActionEvent e) {
            doubleCheckOk = CheckMethod.IdDoubleCheck(IDlist, SignUpIDTxt.getText(), pnl);
            
            if (doubleCheckOk == true) {
               IdCheck = SignUpIDTxt.getText();
            }
         }
      });
      ...
      SignUpComplete.addActionListener(new ActionListener() {
         ...
         public void actionPerformed(ActionEvent e) {
            ...
            // 중복확인을 안눌었을때
            else if (doubleCheckOk == false || !(IdCheck.equals(SignUpIDTxt.getText()))) {
               JOptionPane.showMessageDialog(UserSignUp.this, "ID 중복확인을 해주세요.");
               System.out.println("확인" + IdCheck);
               System.out.println(SignUpIDTxt.getText());
               System.out.println(doubleCheckOk);
            }
