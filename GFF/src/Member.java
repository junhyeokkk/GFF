...
public String toString() {
	return "Member [m_num=" + m_num + ", busan_num=" + busan_num + ", id=" + id + ", password=" + password + ", name="
			+ name + ", phone=" + phone + ", grade=" + grade + ", role=" + role + ", current_address=" + current_address
			+ ", created_date=" + created_date + ", modifieded_date=" + modifieded_date + ", status=" + status + "]";
}
